...
import { GoldOzService, GoldOzPricePoint } from '../services/gold-oz.service';
import { GoldOzChartComponent, GoldOzChartPoint } from '../components/gold-oz-chart/gold-oz-chart.component';

@Component({
  selector: 'app-gold-oz-page',
  standalone: true,
  imports: [
    CommonModule,
    FormsModule,
    RouterModule,
    GoldOzChartComponent
  ],
  template: `
      ...
      <div class="container mx-auto px-4 py-8">
        ...
        <div class="text-center mb-8">
          ...
          <h1 class="text-4xl font-bold text-gray-900 dark:text-white mb-2">
            Gold Price Chart (Ounces)
          </h1>
          <p class="text-gray-600 dark:text-gray-400">
            AUD per ounce - Historical data only
          </p>
        ...
        <div *ngIf="!isLoading() && !error()" class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <div class="flex gap-2">
                    <button
                      *ngFor="let preset of historyPresets"
                      ...
                      [class]="days() === preset.days ? 'bg-amber-600 text-white' : 'bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300'"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
              <div class="flex items-center justify-between">
                ...
                <button
                  ...
                  [class]="isDark() ? 'bg-amber-600' : 'bg-gray-200 dark:bg-gray-700'"
          ...
          <div class="lg:col-span-2">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
              <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Gold Price Chart (AUD/oz)</h3>
              <div class="h-96">
                <app-gold-oz-chart
                  [data]="chartData()"
                  [isDark]="isDark()"
...
export class GoldOzPageComponent implements OnInit, OnDestroy {
  private goldOzService = inject(GoldOzService);
  ...
  goldPrices = signal<GoldOzPricePoint[]>([]);
  isDark = signal(false);
  ...
  // Computed properties
  chartData = computed<GoldOzChartPoint[]>(() => {
  ...
  ngOnInit() {
    console.log('🚀 Gold OZ Page Component ngOnInit');
  ...
  private setupReactiveDataFetching() {
    runInInjectionContext(this.injector, () => {
      ...
      days$.pipe(
        switchMap(days => {
          console.log('🔄 Days changed, fetching gold OZ data for:', days);
          ...
          console.log('📡 Gold OZ API call:', { from, to });

          return this.goldOzService.getGoldOzPrices(from, to).pipe(
            catchError(err => {
              console.error('❌ Gold OZ API error:', err);
        ...
        console.log('✅ Gold OZ data received:', data.length, 'points');
